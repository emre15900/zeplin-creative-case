...
export default function Header() {
  ...
  return (
    <header className="w-full relative bg-white" style={{ height: '135px', boxShadow: '0 5px 15px rgba(136,136,136,0.25)' }}>
      ...
      <div
        className="absolute top-0 right-0 h-[44px] overflow-hidden hidden lg:block"
      ...
      {/* Mobile Top Bar */}
      <div className="lg:hidden absolute top-0 left-0 right-0 h-[44px] bg-[#081542]" style={{ zIndex: 5 }} />
      ...
      >
        <Image
          ...
          width={250}
          height={64}
          className="h-auto w-auto max-h-[90px] hidden lg:block"
        ...
        <Image
          ...
          width={150}
          height={48}
          className="h-auto w-auto max-h-[60px] lg:hidden"
      ...
      <div
        className="absolute hidden lg:flex items-center justify-between"
        style={{
          left: '410px',
          top: '60px',
          right: '50px',
      ...
      {/* Mobile Menu Button */}
      <button
        className="absolute right-6 top-[70px] lg:hidden p-2"
        style={{ zIndex: 30 }}
